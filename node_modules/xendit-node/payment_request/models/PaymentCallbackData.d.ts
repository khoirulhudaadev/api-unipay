 ...
 */
export declare function instanceOfPaymentCallbackData(value: object): boolean;
export declare function PaymentCallbackDataFromJSON(json: any): PaymentCallbackData;
export declare function PaymentCallbackDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentCallbackData;
export declare function PaymentCallbackDataToJSON(value?: PaymentCallbackData | null): any;
